...
define(
  ...
  function (PluginManager, Tools) {
    PluginManager.add('emoji', function (editor, url) {
      var emoticons = [
      ...
      function getHtml() {
		...
		for(var i=1; i < 100; i+=10){
			...
			for(var j=0; j < 10; j++){
				var icon = i+j;
				var emoticonUrl = url + '/img/a_' + icon + '.png';

				emoticonsHtml += '<td><a href="#" data-mce-url="' + emoticonUrl + '" data-mce-alt="a_' + icon + '" tabindex="-1" ' +
				  'role="option" aria-label="' + icon + '"><img src="' +
				  emoticonUrl + '" style="width: 23px; height: 23px" role="presentation" /></a></td>';
