...
class RssBuilder extends \PicoFeed\Syndication\FeedBuilder
{
    ...
    {
        $this->helper = new \PicoFeed\Syndication\Rss20Helper($this->getDocument());
        ...
        $this->helper
        ->buildNode($this->channelElement, 'generator', 'Deruv (http://www.deruv.com)')
